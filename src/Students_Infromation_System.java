...
public class Students_Infromation_System extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(509, 770));
        setResizable(false);
        ...
        cmd_delete.setBackground(new java.awt.Color(204, 255, 204));
        ...
        cmd_search.setBackground(new java.awt.Color(204, 255, 255));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmd_search, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
        ...
        txt_close.setBackground(new java.awt.Color(204, 255, 255));
        txt_close.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txt_close.setForeground(new java.awt.Color(51, 153, 0));
        ...
        txt_home.setBackground(new java.awt.Color(0, 102, 102));
    ...
    private void cmd_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_searchActionPerformed
        ...
        try {
            String sql="select  * from  student_info where Semister=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1, cmd_search.getText());
    ...
    private void cmd_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_saveActionPerformed
        ...
        try {
            ...
            String sql="insert into student_info (Roll,First_name,Last_name,Semister,Year,Birth_date,Mobile_no,Sex,permanent,Present) values(?,?,?,?,?,?,?,?,?,?)";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(p==0)
        {
           try {
            ...
            String sql="Update student_info set Roll='"+value1+"',First_name='"+value2+"',Last_name='"+value3+"',Semister='"+value4+"', Year='"+value5+"',Birth_date='"+value6+"',Mobile_no='"+value7+"',Sex='"+value8+"',permanent='"+value9+"',Present='"+value10+"' where Roll='"+value1+"'";        
